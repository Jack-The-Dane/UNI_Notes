...
- **Assumptions**:
    ...
    - Outcome approximately normally distributed within groups
        
    - Homogeneity of variance
        
- **Diagnostics**:
    
    - Shapiro–Wilk test or Q–Q plots for normality
...
- **Diagnostics**:
    ...
    - Histogram or Q–Q plot of difference scores
...
- **Diagnostics**:
    ...
    - Q–Q plots / Shapiro–Wilk per group
        
    - Levene’s or Brown–Forsythe test
...
- **Diagnostics**:
    ...
    - Multivariate outlier checks (Mahalanobis distance)
...
- **Assumptions**:
    ...
    - Linear relationship between covariates and DVs
        
    - Homogeneity of regression slopes
        
- **Diagnostics**:
    
    - Scatterplots of covariates vs DVs
        
    - Interaction tests between covariates and factors
